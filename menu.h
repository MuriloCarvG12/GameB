...
Menu g_mi_CharacterNamingScreenMenu = {"What will be your name, hero?",0, _countof(g_mi_CharacterNamingScreenItems), g_mi_CharacterNamingScreenItems};
